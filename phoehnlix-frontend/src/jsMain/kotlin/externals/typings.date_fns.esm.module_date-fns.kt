...
import date_fns.`T$5`
import date_fns.`T$6`
import date_fns.`T$10`
import date_fns.`T$11`
import date_fns.`T$14`
import date_fns.`T$15`
...
@JsName("default")
external fun areIntervalsOverlapping(intervalLeft: Interval, intervalRight: Interval, options: `T$3` = definedExternally): Boolean
...
@JsName("default")
external fun parse(dateString: String, formatString: String, referenceDate: Date, options: `T$29` = definedExternally): Date

@JsName("default")
external fun parse(dateString: String, formatString: String, referenceDate: Number, options: `T$29` = definedExternally): Date
