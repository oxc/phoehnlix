...
import org.w3c.xhr.*
import date_fns.`T$3`
import date_fns.esm.`T$24`
import date_fns.`T$5`
import date_fns.`T$6`
import date_fns.esm.`T$25`
import date_fns.esm.`T$26`
import date_fns.esm.`T$27`
import date_fns.`T$10`
import date_fns.`T$11`
import date_fns.esm.`T$28`
import date_fns.esm.`T$29`
...
external interface dateFns {
    ...
    fun areIntervalsOverlapping(intervalLeft: Interval, intervalRight: Interval, options: `T$3` = definedExternally): Boolean
    ...
    fun parse(dateString: String, formatString: String, referenceDate: Number, options: `T$29` = definedExternally): Date
